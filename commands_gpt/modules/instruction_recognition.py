...
from .commands.commands_funcs import COMMANDS
from .commands.graphs import CommandNode
from .static import StaticVar
from . import regex
from .commands import graphs

def recognize_instruction(instruction: str, model: str) -> dict[str, Any]:
    """
...
def recognize_instruction_and_create_graph(prompt: str, model: str) -> \
    ...
    graph_data = recognize_instruction(prompt, model)
    return graphs.build_dependency_graph(graph_data["commands_data"]), graph_data
