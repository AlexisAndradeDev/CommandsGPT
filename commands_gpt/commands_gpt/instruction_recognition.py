...
def recognize_instruction(instruction: str, model: str, commands: dict, 
    ...
    messages = [
        ...
        'content':
            ...
            """\nIf it's impossible to create a graph because a nonexisting command is needed to fulfill the instruction, JUST OUTPUT 'New command needed: "NAME_OF_COMMAND"'."""
            ...
            """\n\n*Your response will have this format, ALWAYS stick to it (and insert the appropiated data, ex.: do not write just "dependent_on_data" on the "dependent_on_data"; fill that field with the necessary data)*:"""
